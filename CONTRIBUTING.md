...
we use the git commit messages to **generate the [change log](https://github.com/tomastrajan/sigma-control-panel-front/blob/master/CHANGELOG.md)**.
...
Even more [examples](https://github.com/tomastrajan/sigma-control-panel-front/commits/master) of commit messages from commit history of this project.
